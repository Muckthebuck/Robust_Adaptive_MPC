classdef (StrictDefaults)helperClusterPositionDetections < matlabshared.tracking.internal.SimulinkBusUtilities ...
        & matlab.system.mixin.CustomIcon
% helperClusterPositionDetections Clusters detections within a small area to a single detection
%
% This is a helper block for example purposes and may be removed or
% modified in the future.
%
% helperClusterPositionDetections clusters all the detections created by a
% single sensor simulation for the example model HighwayLaneFollowingTestBench.
% It is based on helperClusterDetections, but only updates position measurements
% since velocities will be calculated by tracker.
%
%
...
%#codegen
    ...
    methods
        function obj = helperClusterPositionDetections(varargin)
            % Constructor
...
for i = 1:numel(detectionClusters)
    ...
    % Comment out original update to velocity measurement noise since it is
